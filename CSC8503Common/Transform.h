...
namespace NCL {
	namespace CSC8503 {
		...
		public:
			...
			{
				//return Vector3(1 - 2 * (orientation.y * orientation.y + orientation.z * orientation.z), 2 * (orientation.w * orientation.y + orientation.w * orientation.z), 2 * (orientation.x * orientation.z - orientation.w * orientation.y));
